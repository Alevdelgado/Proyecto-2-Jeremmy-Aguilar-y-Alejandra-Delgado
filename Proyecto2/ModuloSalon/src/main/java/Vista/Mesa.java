...
public class Mesa extends javax.swing.JFrame {
    ...
    public Mesa() {
        ...
        /////ImageIcon icono = new ImageIcon("mesa.png"); // no se coloca la imageeeen
        jPanel1.setLayout(new java.awt.GridLayout(filas, columnas));
        ...
        for (int i = 0; i < filas; i++) { 
            for (int j = 0; j < columnas; j++) {
                ...
                botones[i][j] = new JButton("Mesa " + (i * columnas + j + 1)); 
                int numeroMesa = i * columnas + j + 1;
                
                //Mesa mesaInfo = controlador.getInfoMesa(numeroMesa);

                // Agregar el ActionListener al botón
                botones[i][j].addActionListener(new ActionListener() {
                    @Override
                    public void actionPerformed(ActionEvent e) {
                        // Guardar la información de la mesa en la clase Controlador
