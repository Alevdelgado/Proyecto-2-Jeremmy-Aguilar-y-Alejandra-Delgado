...
public void enviarOrden(List<String> listaHamburguesas, List<List> listaIngredientes, int numMesa, int precioTotal) {
    try (Socket socketHamburguesas = new Socket("localhost", 9999);
