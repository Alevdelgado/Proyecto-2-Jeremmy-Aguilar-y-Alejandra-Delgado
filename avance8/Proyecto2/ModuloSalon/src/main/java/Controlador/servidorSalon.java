...
public class servidorSalon extends Thread{
    ...
    public static ventanaSalon tempVentSalon;
    public static servidorSalonCocina tempServerSC;
    public servidorSalon(ventanaSalon tempVent, servidorSalonCocina tempServer) {
        tempVentSalon = tempVent;
        tempServerSC = tempServer;
...
//}
 ...
 public void run() {
    ...
    try {
        ServerSocket serverHamburguesas = new ServerSocket(9109);
        ...
        while (true) {
            ...
            List<Integer> listaHamburguesas = (List<Integer>) objInputStream.readObject();
            ...
            ordenC tempOrden = new ordenC(tempX, tempY);
            tempOrden.agregarHamburSimulacion(listaHamburguesas, listaIngredientes, numMesa);
            
            System.out.println(tempOrden.pasarOrdenToString());
            
            tempVentSalon.cambiarBoton(tempOrden, tempX, tempY);
            
            tempServerSC.enviarConfir(tempX, tempY, tempOrden.pasarOrdenToString());
