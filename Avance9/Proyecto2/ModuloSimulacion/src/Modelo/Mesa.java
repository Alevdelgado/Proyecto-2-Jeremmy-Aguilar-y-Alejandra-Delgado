...
public class Mesa {
    ...
    private List<Integer> hamburguesas;
    private List<List> ingredientes;
    private int numeroMesa;
    private int precio;
    private boolean ocupada;
    
    public Mesa(List<Integer> hamburguesas,List<List> ingredientes, int numeroMesa, int precio) {
    ...
    public List<Integer> getHamburguesas(){
